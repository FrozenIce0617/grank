...
class RankingDistribution extends Component<Props, State> {
  _id: string = 'RankingDistribution';
    ...
    return (
      <div className="ranking-distribution">
        ...
        <Chart
          ...
          domainId={domainId}
          isLoading={(loading || areWinnersAndLosersLoading) && !isSilentUpdate}
          period={period}
          notes={notes}
